...
<script>
    ...
    function getQuestions() {
        ...
        $.ajax({
            type: "get",
            url: "/Pizza/tutor/getQuestions/checkTest",
            data: {test: test},
            contentType:
            ...
            success: function (check) {
                ...
                $.ajax({
                    type: "get",
                    url: "/Pizza/tutor/getTopics/getQuestionsByTestId",
                    data: {test: test},
                    contentType:
                        "application/json; charset=utf-8",
    ...
    function getAnswers() {
        ...
        try {
            $.ajax({
                type: "get",
                url: "/Pizza/tutor/getQuestions/getAnswersByQuestion",
    ...
    function checkQuestion() {
        ...
        $.ajax({
            type: "get",
            url: "/Pizza/tutor/getQuestions/checkQuestion",
            data: {question: question},
            contentType:
                "application/json; charset=utf-8",
            success: function (check) {
    ...
    function saveAnswer() {
        ...
        if (answer != '' && question != '') {
            $.ajax({
                type: "get",
                url: "/Pizza/tutor/getQuestions/addAnswer",
    ...
    function deleteQuestion() {
        ...
        $.ajax({
            type: "get",
            url: "/Pizza/tutor/getQuestions/deleteQuestion",
            data: {question: question},
            contentType:
                "application/json; charset=utf-8",
            success: function () {
    ...
    function deleteAnswer(answerId) {
        $.ajax({
            type: "get",
            url: "/Pizza/tutor/getQuestions/deleteAnswer",
